...
oskprefix = ['прогнившее', 'тупое', 'уёбищное', 'ебанутое', 'безмозглое',
             ...
             'залупососное', 'гомеопатическое', 'дебилоидное', 'тупоголовое']
...
postfix = ['у тебя вообще нету алиби', 'и твоя мать давно уже не жива',
           ...
           'снимись в видосе брайн мапса хахаха', 'убейся пж', "заткнись в общем",
           'ваще просто исчезни с глаз долой']
...
workwords = ['Так уж и быть, {user.first_name}, ради тебя - сгоняю.',
            ...
            "Окей, хорошо!",
            "Конечно, без проблем, {user.first_name}!",
            "Да без вопросов чувидзе В)",
            "Йоу, конечно, я с радостью сгоняю ради тебя, {user.first_name}!",
            "Базару Джексон В)",
            "Да как гриться Базару Джексон, {user.first_name}!",
            "Да, да, щас схожу. Базару Джексон.",
            "Чё чё чел? Чё чё чел? Базару Джексон",
            "Хмммм, окей\nБАЗАРУ ДЖЕКСОН ХАХАХАХА",
            "На... работу? Нууууу... Базару Джексон",
            "Ба-Ба-Базару Джек-Дже-Джексон ~",
            "Каменоломня или Дуборубье?\nА как насчёт и то, и другое?\nДа Базару Джексон",
            "Я продал пару слэш фанфиков про раста и гейста норм?",
            "Базара Джексон, на работу так на работу",
            "6a3apa D>I<eKcoH",
            'А как насчёт вместо меня на работу сходит {user.first_name}?\nНикто не против?\nНу тогда Базара Джексон',
            "Ах!~ На работу...~~~ Ммх!~",
            "Заколлабил с тлт, получил бабло, Базара Джексон",
            "Я короче в северную корею продал ядерку норм тема?",
            "Тск! Ты хоть знаешь, с кем ты так разговариваешь!? >:(\n\nааааа ты знаешь... Ну тогда Базару Джексон",
            "Я убил раста за деньги",
            "Вот и нахуя я тебе деньги зарабатываю, если ты всё равно всё просрёшь на крутки?",
            "Exception on _main thread: workwords[random.choice()] is out of memory",
            "плодя купи мне круиз на скамкоины",
            "КАК ЕГО НАКЛОНИТЬ НАД ПЛИТОЙ И ОТТРАЗАТЬ",
            "Я слил фотки саши и юли за бабло норм тема?",
            "Базара Джексон",
            "Щит мэн, вот ду ю мин гоу то ворк? Ай кэнт ворк айм э телеграм бот ю ступид фак! Ай фак юр бурщит, щит!",
            "эх... ладно уж...",
            "у меня депрессия я не хочу ну пожааалуйста =(",
            "ПОЖАЛУЙСТА ПОМОГИТЕ ОН ЗАСТАВЛЯЕТ МЕНЯ ПИСАТЬ ОТВЕТЫ БУДТО БЫ ЭТО БОТ\nПОЖАЛУЙСТА УМОЛЯЮ ПОМОГИТЕ\nПОЖАЛУ",
            "Дорогой дневник, сегодня я поработал прорабом. Ощущалось будто бы профессиональным рабом.",
            "вот именно это не эти ваши фансервисы а долгий труд и хорошая задумка",
            "What about Титьки?.. What about титьки?\nБазару Джексон!",
            "Майню сатоши в майнкрафте",
            "Вывожу крипов в фиат",
            "Отрезаю головки от спичек с помощью огромного шипастого аппарата",
            "Гну спину от лени",
            "{user.first_name} - ну ты блять? Типа? Ты не выкупаешь?\nой\nне погоди я не тебе\nБазара Джексон в общем пацаны",
            "Скачал крокодило бомбондилло и он биткоины выкачивает норм ваще нет?",
            "Я вот в хомяке натапал специально для тебя, {user.first_name}",
            "На работу? Базара Джексон\nПойду выводить крипов в фиат",
            "да я б лучше в дотку поиграл если честно, сори...(",
            "Ой бля, сёдня день кобальта\nЕго когда добиваешь на крипах за него 200 рублей платят"]
denialWords = ["не",
              "хммм... а как насчёт нет?",
              "да бля ну не буду",
              "Н-Е-Т",
              "{user.first_name} иди нахуй, не пойду",
              "да заткнись в пизду сука",
              "да я лучше в дотку пойду поиграю",
              "да я лучше в майн пойду поиграю",
              "не, мне похуй, я пойду в амонгас пару каток сгоняю",
              "не-а, не пойду :Р",
              "Прости, {user.first_name}, но мне не хочется.",
              "Пфффф, да похуй мне, не пойду",
              "Чё чё чел? Чё чё чел? Кот нассал\nкороче не буду я работать",
              "Меня уволили, какая работа нахуй",
              "Да похуй мне\nПохуй\nПО-ХУЙ\nНе буду работать и всё тут",
              "хихихи ты даже не заметишь а я не пойду на самом деле работать ;)",
              "хз не хочется сори",
              "{user.first_name}... иди нахуй...",
              "у меня депрессия я не хочу ну пожааалуйста =(",
              "Гну спину от лени",
              "я устал",
              "{user.first_name} - хуила\nхахахахаха затроллил лалку",
              "На... работу? Нууууу... Не хочу.",
              "Exception on _main thread: denialWords[random.choice()] is out of memory",
              "Блять вот я отработал смену на заводе но меня заскамили сказали что я могу купить брейнрота итальянского и деньги тупо спиздили прикинь нахуй?",
              "Я отработал, но слил все деньги на концерт ТЛТ сори лол ;P",
              "Блять вот ты и сходи, хули я то"]
            ...
            if await check_account(event, account):
                if "scamCoins" in account:
                    if event.date - datetime.strptime(f'{account["lastWork"]}+00:00', '%Y-%m-%d %H:%M:%S%z') >= timedelta(minutes = 10):
                        ...
                        if randint(1, 14) == 7:
                            await event.reply(f'{user.first_name}, ну ты {choice(oskmain)} {choice(oskprefix)}, дай отдохнуть {choice(mat)}... Заебался я в край {choice(mat)}')
                        else:
                            await event.reply(choice(denialWords))
                else:
