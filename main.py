...
workwords = [f'Так уж и быть, {user.first_name}, ради тебя - сгоняю.\n> Вы заработали {payout} скамкоинов!',
            f'не\n> Вы заработали {payout} скамкоинов!',
            f'We work to earn the right to work to earn the right to work to earn the right to work to earn the right to work to earn the right to give ourselves the right to buy ourselves the right to live to earn the right to die \n> Вы заработали {payout} скамкоинов!',
            f'Я не так много придумал новых строчек для работы, {user.first_name}, так что иди нахуй {choice(mat)}!\n> Вы заработали {payout} скамкоинов!',
            f'Ну хорошо, пойду рефакторить код второй раз после того как ушёл спать и забыл сохраниться\n> Вы заработали {payout} скамкоинов!',
            f'ЭЭЭЭЭ ВСМЫСЛЕ РАБОТАТЬ а если я не хочу...\nсука меня ержаном сделали это пиздец господа!\n> Вы заработали {payout} скамкоинов!',
            f'ну неее( ну мне лень( я не хочу((( ну лааадно, {user.first_name}(\n> Вы заработали {payout} скамкоинов!',
            f'Опять на работу... Опять яндекс... Опять склад... Опять 24 часа смены... {choice(mat)}...\n> Вы заработали {payout} скамкоинов!',
            f'Оке, без вопросов хули\n> Вы заработали {payout} скамкоинов!',
            f'да не, ну нахуй, какая работа, ебану чтоль бл\nойду лучше у бомжа пару копеек спизжу\n> Вы заработали {payout} скамкоинов!',
            f'Вжжжж Вжжжж Бум Бум Бум чача чача чача КРРРРК\nРОБОТ БОТИС ИДЁТ НА РАБОТУ\n> Вы заработали {payout} скамкоинов!',
            f'с тебя бутылка пива - с меня зарплата, идёт?\n> Вы заработали {payout} скамкоинов!',
            f'Пойдём в макдак, мне там уютней\nВозьмём картошку на двоих\nА крошки скормим голубям\nИ в парке уткам...\n\nБлять так я же работать в макдаке буду( Ну ёбаный в рот того всего {choice(mat)}\n> Вы заработали {payout} скамкоинов!',
            f'на работу говоришь?\nsome time\nyou gotta believe me\nit\'s not my fault that there\'s so much on tv\n\n> Вы нихуя не заработали! Ботис обленился!\n\nшутка\n> Вы заработали {payout} скамкоинов!',
            f'Иду работать ладно {choice(mat)}\n{user.first_name} ты в 1% стремишься попасть, да? Свинья капиталистическая блять...\nладно, уважаю)\n> Вы заработали {payout} скамкоинов!',
            f'БАБКИ БАБКИ СУКА БАБКИ\n> Вы заработали {payout} скамкоинов!',
            f'я мишка гуми бэр вкуснейший гуми бэр\nзаходите в пивнуху по адресу московская 33 дробь 2\nвот такая нынче работа хули людей в пивнуху зазывать\n> Вы заработали {payout} скамкоинов!',
            f'да иди нахуй, я лучше пентагон взломаю и файлы эпштейна солью за бабки чем работать буду\n> Вы заработали {payout} скамкоинов!']
            ...
            if randint(1, 100) != 42:
                ...
                if account:
                    if event.date - datetime.strptime(f'{account["lastWork"]}+00:00', '%Y-%m-%d %H:%M:%S%z') >= timedelta(minutes = 10):
                        await event.respond(choice(workwords), parse_mode='markdown')
